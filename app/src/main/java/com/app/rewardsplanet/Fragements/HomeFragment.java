    ...
    private void setupClickListeners() {
        ...
        if (card_spinner != null) {
            card_spinner.setOnClickListener(v ->
                    startActivity(new Intent(
                            requireContext(),
                            com.app.rewardsplanet.lucky_draw.activity_daily_spin.class
                    ))
            );
        }
        ...
        if (card_lucky_draw != null) {
            card_lucky_draw.setOnClickListener(v ->
                    startActivity(new Intent(
                            requireContext(),
                            com.app.rewardsplanet.lucky_draw.activity_lucky_draw.class
                    ))
            );
        }
        ...
        if (cardInvite != null) {
            cardInvite.setOnClickListener(v ->
                    startActivity(new Intent(
                            requireContext(),
                            com.app.rewardsplanet.invite.activity_refer_earn.class
                    ))
            );
        }
