...
import com.example.rgamer.profile.ReferralUtil;
...
public class layout_invite extends Fragment {
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(
                com.example.rgamer.R.layout.activity_layout_invite,
                container,
                false
        );
        makeFullScreen();
        // UI
        txtCode = view.findViewById(com.example.rgamer.R.id.txtReferralCode);
        edtReferral = view.findViewById(com.example.rgamer.R.id.edtReferral);
        btnCopy = view.findViewById(com.example.rgamer.R.id.btnCopy);
        btnValidate = view.findViewById(com.example.rgamer.R.id.btnValidate);

        btnWhatsapp = view.findViewById(com.example.rgamer.R.id.btnWhatsapp);
        btnTelegram = view.findViewById(com.example.rgamer.R.id.btnTelegram);
        btnFacebook = view.findViewById(com.example.rgamer.R.id.btnFacebook);
        btnMessenger = view.findViewById(com.example.rgamer.R.id.btnMessenger);
